...
public class WarnListinfo {
    ...
    private DaviceInfoCurrent daviceInfoCurrent;
    ...
    public DaviceInfoCurrent getDaviceInfoCurrent() {
        return daviceInfoCurrent;
    }

    public void setDaviceInfoCurrent(DaviceInfoCurrent daviceInfoCurrent) {
        this.daviceInfoCurrent = daviceInfoCurrent;
    }
}
